  ...
  Mapsheet.Point.prototype = {
	...
	*/
	...
	Mapsheet.Providers.Google = function(options) {
		...
		this.mapOptions = merge_options( { mapTypeId: google.maps.MapTypeId.SATELLITE }, options.mapOptions || {
          tilt: 45,
          zoom: 20,
          zoomControl: true,
          scaleControl: true,
...
//perform geoloacation
      if(!!navigator.geolocation) {
		...
		*/
	    ...
	    var pinImage = new google.maps.MarkerImage("https://cdn.mlhdocs.com/adc_cms/ten-x/geoFacts/img/building.png",
	...
	*/
	...
	Mapsheet.Providers.Leaflet = function(options) {
		...
		var attribution = 'Map data &copy; <a href="http://openstreetmap.org">OpenStreetMap</a> contributors, <a href="http://creativecommons.org/licenses/by-sa/2.0/">CC-BY-SA</a>, tiles &copy; <a href="http://www.mapquest.com/" target="_blank">MapQuest</a> <img src="https://developer.mapquest.com/content/osm/mq_logo.png" />';
